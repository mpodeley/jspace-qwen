...
for \textbf{all 20 ordered relation pairs in all three models}, while
matched-norm random controls do nothing. It \textbf{generalizes}:
directions built on half the operands flip the held-out half; directions
built in one prompt formulation transfer to unseen ones; and the
